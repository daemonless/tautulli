...
ARG PACKAGES="python3 python312 py312-pip py312-setuptools py312-sqlite3 py312-pyopenssl git-lite ca_root_nss"
...
# Install dependencies (py312-setuptools provides pkg_resources for bundled apscheduler)
